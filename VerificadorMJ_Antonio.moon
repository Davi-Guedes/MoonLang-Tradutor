...
THRILLER achou WHOS_BAD True
    SING "Resultado: essa musica parece ser do Michael Jackson."
    SING "Sinal sonoro: 1 vez."
    HEEHEE
OTHERWISE
    SING "Resultado: essa musica nao foi identificada como sendo do Michael Jackson."
    SING "Sinal sonoro: 2 vezes."
    HEEHEE
    HEEHEE
ENDTHRILLER